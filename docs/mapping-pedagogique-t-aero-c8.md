# Mapping pédagogique — T AERO / PSE / Module C8

Traçabilité de la séquence 2 de PSE en T AERO, au format défini par
...
[`mapping-pedagogique-t-aero.md`](mapping-pedagogique-t-aero.md).
...
[`mapping-pedagogique-t-tci-c8.md`](mapping-pedagogique-t-tci-c8.md). Le contenu est
...
| Cours consultés | `BACPRO/T/TAERO PSE/PSE - Progression et sequences/Sequences/Sequence_2/S2_seance_01_declarer_un_at_ou_une_mp/S2_seance_01_complete.md`, `…/S2_seance_02_responsabilites_et_reparation/S2_seance_02_complete.md` |
| Sources citées par le cours | `BACPRO/T/TAERO PSE/PSE - Progression et sequences/Sequences/Sequence_2/S2_SOURCES_PEDAGOGIQUES.md` — programme, définition de la sous-épreuve, référentiel du diplôme, et rappel que les données réglementaires évolutives sont à revérifier |
...
Le fil rouge est celui des cours de la classe : l'atelier AMA, avec Théo.
...
[
  {
    ...
    "sources": [
      ...
      },
      {
        ...
        "referenceRelative": "BACPRO/T/TAERO PSE/PSE - Progression et sequences/Sequences/Sequence_2/S2_seance_01_declarer_un_at_ou_une_mp/S2_seance_01_complete.md"
      },
      {
        "typeSource": "COURS",
        "titreSource": "Séquence 2 — Séance 2 : responsabilités et réparation",
        "referenceRelative": "BACPRO/T/TAERO PSE/PSE - Progression et sequences/Sequences/Sequence_2/S2_seance_02_responsabilites_et_reparation/S2_seance_02_complete.md"
      },
      {
...
`prisma/content/pse-t-aero-c8.ts`, qui paramètre le générateur commun
